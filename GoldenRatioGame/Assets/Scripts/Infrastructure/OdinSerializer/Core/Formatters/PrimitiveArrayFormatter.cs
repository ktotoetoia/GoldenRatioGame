...
namespace IM.OdinSerializer
{
    ...
    public sealed class WeakPrimitiveArrayFormatter : WeakMinimalBaseFormatter
    {
            ...
            if (reader.PeekEntry(out name) == EntryType.PrimitiveArray)
            {
                switch (this.PrimitiveType)
                {
                    case PrimitiveArrayType.PrimitiveArray_char:
                        {
                            char[] readValue;
                            reader.ReadPrimitiveArray(out readValue);
                            value = readValue;
                        }
                        break;
        ...
        protected override void Write(ref object value, IDataWriter writer)
        {
            switch (this.PrimitiveType)
            {
                case PrimitiveArrayType.PrimitiveArray_char   : writer.WritePrimitiveArray((char   [])value); break;
                case PrimitiveArrayType.PrimitiveArray_sbyte  : writer.WritePrimitiveArray((sbyte  [])value); break;
                case PrimitiveArrayType.PrimitiveArray_short  : writer.WritePrimitiveArray((short  [])value); break;
                case PrimitiveArrayType.PrimitiveArray_int    : writer.WritePrimitiveArray((int    [])value); break;
                case PrimitiveArrayType.PrimitiveArray_long   : writer.WritePrimitiveArray((long   [])value); break;
                case PrimitiveArrayType.PrimitiveArray_byte   : writer.WritePrimitiveArray((byte   [])value); break;
                case PrimitiveArrayType.PrimitiveArray_ushort : writer.WritePrimitiveArray((ushort [])value); break;
                case PrimitiveArrayType.PrimitiveArray_uint   : writer.WritePrimitiveArray((uint   [])value); break;
                case PrimitiveArrayType.PrimitiveArray_ulong  : writer.WritePrimitiveArray((ulong  [])value); break;
                case PrimitiveArrayType.PrimitiveArray_decimal: writer.WritePrimitiveArray((decimal[])value); break;
                case PrimitiveArrayType.PrimitiveArray_bool   : writer.WritePrimitiveArray((bool   [])value); break;
                case PrimitiveArrayType.PrimitiveArray_float  : writer.WritePrimitiveArray((float  [])value); break;
                case PrimitiveArrayType.PrimitiveArray_double : writer.WritePrimitiveArray((double [])value); break;
                case PrimitiveArrayType.PrimitiveArray_Guid   : writer.WritePrimitiveArray((Guid   [])value); break;
            }
        }
    }
}