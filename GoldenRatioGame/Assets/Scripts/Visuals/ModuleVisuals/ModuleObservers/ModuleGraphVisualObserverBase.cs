...
namespace IM.Visuals
{
    public class ModuleGraphVisualObserverBase : IModuleVisualMap, IDisposable, IEditorObserver<IModuleGraphReadOnly>
    {
        ...
        private void HandleModuleAdded(IModule module)
        {
            ...
            if (!extensibleModule.Extensions.TryGet(out IModuleVisualObjectProvider moduleVisual))
        ...
        protected virtual void HandleModuleAdded(IExtensibleModule extensibleModule,IModuleVisualObjectProvider moduleVisualObjectProvider)
        {
        ...
        public virtual void Dispose()
        {
            ...
            {
                GetObjectPool(module.Extensions.Get<IModuleVisualObjectProvider>()).Release(visualObject);
            }
        }
    }
}