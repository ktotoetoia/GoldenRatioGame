...
{
    public class KeyAbilityModuleEditingContextSerializer : ComponentSerializer<KeyAbilityModuleEditingContextMono>
    {
        public override object CaptureState(KeyAbilityModuleEditingContextMono component)
        {
        ...
        public override void RestoreState(KeyAbilityModuleEditingContextMono component, object state, Func<string, GameObject> resolveDependency)
        {
